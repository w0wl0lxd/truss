...
impl PackManifest {
    ...
    fn validate_condition(&self, condition: &str) -> Result<()> {
        ...
        // Simple check: extract identifiers from the condition and verify they're declared.
        // This is a basic heuristic; minijinja will do full validation during evaluation.
    ...
    /// Validate that all source files exist in the given pack directory.
    ...
    pub fn eval_condition(
        ...
        eprintln!("Condition: {}, Context: {:?}, Rendered: {}", condition, ctx, rendered);
    ...
    /// Note: conditions are not evaluated here; they are evaluated during rendering.
    pub fn to_template(
        &self,
        pack_dir: &Path,
...
impl ManifestVariable {
    ...
    pub fn validate(&self) -> Result<()> {
        ...
        if let Some(default) = &self.default {
            self.validate_value(&default.to_string())?;
        }
